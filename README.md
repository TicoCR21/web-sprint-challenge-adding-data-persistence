...
1. Explain the difference between `Relational Databases` and `SQL`.
  ...
  A relational database is a collection of information known as tables that defines how data is to be stored for easy access. SQL is a language normally used to manipulate relational databases.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  A third table in which a one to may relationship may be defined.
